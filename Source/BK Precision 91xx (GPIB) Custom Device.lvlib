...
<Library LVVersion="11008008">
	...
	<Item Name="BK Precision 91xx (GPIB) Main Page.vi" Type="VI" URL="../BK Precision 91xx (GPIB) Main Page.vi"/>
	<Item Name="BK Precision 91xx (GPIB) Initialization VI.vi" Type="VI" URL="../BK Precision 91xx (GPIB) Initialization VI.vi"/>
	<Item Name="BK Precision 91xx (GPIB) RT Driver VI.vi" Type="VI" URL="../BK Precision 91xx (GPIB) RT Driver VI.vi"/>
